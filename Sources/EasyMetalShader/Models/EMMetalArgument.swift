...
public enum EMMetalArgument {
    ...
    case double(Double)
    case double2(simd_double2)
    case double3(simd_double3)
    case double4(simd_double4)
    case double2x2(simd_double2x2)
    case double3x3(simd_double3x3)
    case double4x4(simd_double4x4)
